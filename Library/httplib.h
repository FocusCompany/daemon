...
namespace httplib {
    ...
    public:
        ...
        std::shared_ptr<Response> del(const char *path, const std::string &body, const char *content_type);

        std::shared_ptr<Response> del(const char *path, const Headers &headers, const std::string &body, const char *content_type);
        ...
        std::shared_ptr<Response> del(const char *path, const Params &params);

        std::shared_ptr<Response> del(const char *path, const Headers &headers, const Params &params);
...
// HTTP client implementation
    inline Client::Client(
            ...
            : host_(host), port_(port), timeout_sec_(timeout_sec), http_version_(http_version), host_and_port_(host_ + ":" + std::to_string(port_)) {
    }
    ...
    inline std::shared_ptr<Response> Client::post(const char *path, const Headers &headers, const std::string &body, const char *content_type) {
        Request req;
        req.method = "POST";
        req.headers = headers;
        req.path = path;
    ...
    inline std::shared_ptr<Response> Client::put(const char *path, const Headers &headers, const std::string &body, const char *content_type) {
        Request req;
        req.method = "PUT";
        req.headers = headers;
        req.path = path;
    ...
    inline std::shared_ptr<Response> Client::del(const char *path, const std::string &body, const char *content_type) {
        return del(path, Headers(), body, content_type);
    }

    inline std::shared_ptr<Response> Client::del(const char *path, const Headers &headers, const std::string &body, const char *content_type) {
        Request req;
        req.method = "DELETE";
        req.headers = headers;
        req.path = path;
    ...
    inline std::shared_ptr<Response> Client::del(const char *path, const Params &params) {
        return del(path, Headers(), params);
    }

    inline std::shared_ptr<Response> Client::del(const char *path, const Headers &headers, const Params &params) {
        std::string query;
        for (auto it = params.begin(); it != params.end(); ++it) {
            if (it != params.begin()) {
                query += "&";
        ...
        return del(path, headers, query, "application/x-www-form-urlencoded");
    }
