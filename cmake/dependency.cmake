...
function(include_target_dependency_in_target_package dependencyTarget packageTarget)
    ...
    foreach(LIB ${DEPLIBS})
        if(EXISTS ${LIB})
            get_filename_component(VAROUT ${LIB} NAME)
            message("Found depency of ${dependencyTarget}: ${VAROUT}. Including as a package copy target of ${packageTarget}.")
            add_custom_command(TARGET ${packageTarget} POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy_if_different ${LIB} "$<TARGET_FILE_DIR:${packageTarget}>")
        endif()
    endforeach()
endfunction()